  ...
  >
    ...
    >
      ...
      <a href="{{route('home')}}" class="lg:hidden">
        <img class="dark:hidden" src="{{asset('Logo/logo12.png')}}" style="height: 43px" alt="Logo" />
        <img
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="{{asset('logo/owner3.png')}}" alt="User" />            
          </span>

          <span class="text-theme-sm mr-1 block font-medium"> คุณ {{Auth::user()->name}} </span>
        ...
        >
          ...
          >
            ...
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
              <svg
